...
#ifndef __CFG_TMP102_MODULE_H__
#define __CFG_TMP102_MODULE_H__
...
typedef enum
{
    ...
    TMPNOPT_INTERRUPT_CLEAR_S,
    TMP_TO_OPT_INTERRUPT_S,
    EXIT_TMP
} tmp102_state_s;
...
/**
 * @brief       Function for TMP10x clear interrupt setting
 */
int tmp102_intr_lowhigh_clear(void);

/**
 * @brief       Function for TMP10x move to interrupt clear state
 */
void tmp102_intr_lowhigh_clear_state(void);

void tmp102nopt3001_intr_clear_state(void);

bool tmp102_get_enable_intr(void);
