...
#define CFG_DEBUG_OUT_USES_RTT 1
#if defined(CFG_DEBUG_OUT_USES_RTT) && (CFG_DEBUG_OUT_USES_RTT == 1)
...
{
#if defined(CFG_DEBUG_OUT_USES_RTT) && (CFG_DEBUG_OUT_USES_RTT == 1) || defined(FEATURE_CFG_DEBUG_OUT_TO_TBC)
    va_list ParamList;
#endif
...
/**
 * @brief print out debug msg (output interface:i2c slave(depend on FEATURE_CFG_DEBUG_OUT_TO_TBC), rtt(depend on CFG_DEBUG_OUT_USES_RTT))
 *
...
/**
 * @brief print out dump data (output interface:i2c slave(depend on FEATURE_CFG_DEBUG_OUT_TO_TBC), rtt(depend on CFG_DEBUG_OUT_USES_RTT))
 *
 * @param[in]  dbgID           Value of the msg ID (defined in cfg_dbg_log.h eg.CDBG_MAIN_LOG)
