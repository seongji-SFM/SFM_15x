...
#define FEATURE_CN0_SATELLITE_ID
#define GPS_NMEA_CHECK_CHECKSUM
#define FEATURE_HDOP_VALUE_CHECK
...
#define COLD_START_TIME (2*60*60)
#define CGPS_LATITUDE_SIGFOX 4
#define CGPS_LONGITUDE_SIGFOX 4
...
typedef enum
{
    ...
    CGPS_BELOW_HDOP_9,
    CGPS_BELOW_HDOP_10,
    CGPS_BELOW_HDOP_15 = 15,
    CGPS_BELOW_HDOP_20 = 20,
}CGPS_HDOP_CHECK_e;
#endif
...
#ifdef FEATURE_HDOP_VALUE_CHECK
/**
 * @brief        Get the set hdop value.
 * @return       Returns the set hdop value from 1 to 9. 
 */
uint8_t get_hdop_value_check(void);
