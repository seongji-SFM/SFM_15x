...
extern bool m_cfg_ACC_ISR_detected;
 ...
 */
uint32_t cfg_bma250_req_suppend_mode(void);
...
void BMA_I2C_routine(void);
int bma250_acc_event(void);
void  bma250_read_chip(void);
void cfg_bma250_interrupt_init(void);
void cfg_bma250_early_init(void);
void cfg_bma250_init(void);
