 ...
 */
#ifndef __CFG_SIGFOX_MODULE_H__
#define __CFG_SIGFOX_MODULE_H__
...
#define DATA_MODULE_TYPE_NONE       (0)
#define DATA_MODULE_TYPE_SF_ONSEMI  (1)
#define DATA_MODULE_TYPE_SF_MONARCH (2)
...
#include "cfg_sigfox_module_monarch.h"
#endif
